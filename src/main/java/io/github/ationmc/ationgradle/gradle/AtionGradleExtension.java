 ...
 * @author Enaium
 */
public class AtionGradleExtension {
    /**
    ...
    public AtionGradleExtension(Project project) {
        this.project = project;
    }

    public File getUserCache() {
        File userCache = new File(project.getGradle().getGradleUserHomeDir(), "caches" + File.separator + "ationmc");
